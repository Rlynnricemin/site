import{d as Z,r as W,_ as m,l as G,w as o,j as c,k as b,f as e,b as n,e as t,ay as y,aB as j,N as w,O as v,o as H,z as P,H as K,t as f,a as V,h as J,F as X,s as B}from"./index.6a8b5f17.js";const D=Z({setup(){return{checked:W(!1)}}}),L=n("pre",{class:"language-vue"},[n("code",null,[n("span",{class:"token tag"},[n("span",{class:"token tag"},[n("span",{class:"token punctuation"},"<"),t("template")]),n("span",{class:"token punctuation"},">")]),t(`
...
`),n("span",{class:"token punctuation"},"}"),n("span",{class:"token punctuation"},")"),n("span",{class:"token punctuation"},";"),t(`
`)])]),n("span",{class:"token tag"},[n("span",{class:"token tag"},[n("span",{class:"token punctuation"},"</"),t("script")]),n("span",{class:"token punctuation"},">")]),t(`
`)])],-1);function x(a,s,I,h,k,r){const u=c("a-switch"),g=c("demo-box");return b(),G(g,{jsfiddle:{us:"The most basic usage.",cn:"\u6700\u7B80\u5355\u7684\u7528\u6CD5\u3002",docHtml:`<h2 id="zh-CN">zh-CN <a class="header-anchor" href="#zh-CN">
...
`),n("span",{class:"token punctuation"},"}"),n("span",{class:"token punctuation"},")"),n("span",{class:"token punctuation"},";"),t(`
`)])]),n("span",{class:"token tag"},[n("span",{class:"token tag"},[n("span",{class:"token punctuation"},"</"),t("script")]),n("span",{class:"token punctuation"},">")]),t(`
`)])],-1);function E(a,s,I,h,k,r){const u=c("a-switch"),g=c("a-button"),p=c("demo-box");return b(),G(p,{jsfiddle:{us:"Disabled state of `Switch`.",cn:"Switch \u5931\u6548\u72B6\u6001\u3002",docHtml:`<h2 id="zh-CN">zh-CN <a class="header-anchor" href="#zh-CN">
          <span aria-hidden="true" class="anchor">#</span>
        </a></h2>
<p>Switch \u5931\u6548\u72B6\u6001\u3002</p>
<h2 id="en-US">en-US <a class="header-anchor" href="#en-US">
...
`),n("span",{class:"token punctuation"},"}"),n("span",{class:"token punctuation"},")"),n("span",{class:"token punctuation"},";"),t(`
`)])]),n("span",{class:"token tag"},[n("span",{class:"token tag"},[n("span",{class:"token punctuation"},"</"),t("script")]),n("span",{class:"token punctuation"},">")]),t(`
`)])],-1);function an(a,s,I,h,k,r){const u=c("a-switch"),g=c("check-outlined"),p=c("close-outlined"),l=c("demo-box");return b(),G(l,{jsfiddle:{us:"With text and icon.",cn:"\u5E26\u6709\u6587\u5B57\u548C\u56FE\u6807\u3002",docHtml:`<h2 id="zh-CN">zh-CN <a class="header-anchor" href="#zh-CN">
          <span aria-hidden="true" class="anchor">#</span>
        </a></h2>
<p>\u5E26\u6709\u6587\u5B57\u548C\u56FE\u6807\u3002</p>
<h2 id="en-US">en-US <a class="header-anchor" href="#en-US">
...
`),n("span",{class:"token punctuation"},"}"),n("span",{class:"token punctuation"},")"),n("span",{class:"token punctuation"},";"),t(`
`)])]),n("span",{class:"token tag"},[n("span",{class:"token tag"},[n("span",{class:"token punctuation"},"</"),t("script")]),n("span",{class:"token punctuation"},">")]),t(`
`)])],-1);function pn(a,s,I,h,k,r){const u=c("a-switch"),g=c("demo-box");return b(),G(g,{jsfiddle:{us:'`size="small"` represents a small sized switch.',cn:'`size="small"` \u8868\u793A\u5C0F\u53F7\u5F00\u5173\u3002',docHtml:`<h2 id="zh-CN">zh-CN <a class="header-anchor" href="#zh-CN">
          <span aria-hidden="true" class="anchor">#</span>
        </a></h2>
...
`,order:3,title:{"zh-CN":"\u4E24\u79CD\u5927\u5C0F","en-US":"Two sizes"},relativePath:"components/switch/demo/size.vue",sourceCode:"",jsSourceCode:"",isdemo:!1}},{default:o(()=>[n("div",null,[e(u,{checked:a.checked1,"onUpdate:checked":s[0]||(s[0]=p=>a.checked1=p)},null,8,["checked"]),on,e(u,{checked:a.checked2,"onUpdate:checked":s[1]||(s[1]=p=>a.checked2=p),size:"small"},null,8,["checked"])])]),htmlCode:o(()=>[cn]),jsVersionHtml:o(()=>[ln]),_:1},8,["jsfiddle"])}const un=m(en,[["render",pn]]),gn=Z({components:{CheckOutlined:y,CloseOutlined:j},setup(a){const s=W(""),I=W(""),h=({type:l,val:C})=>{switch(l){case"title":I.value=C||"";break;case"reset":p();break}},k=w({checked:!1,disabled:!1,icon:!1,text:!1,size:"default",loading:!1}),r={...k},u=l=>{let C="",A="";for(let i in l)i==="icon"?l[i]&&(A=`
        ...
        <\/script>`):i==="checked"?l.checked&&(C+=` :checked="${l.checked}"`):i==="text"?l.text&&(C+=' checked-children="\u5F00" un-checked-children="\u5173"'):C+=l[i]!==r[i]?typeof r[i]=="boolean"?` ${i}`:` ${i}="${l[i]}"`:"";return`<template>
          <a-switch${C}>${l.icon?`
            <template #checkedChildren><check-outlined /></template>
            <template #unCheckedChildren><close-outlined /></template>
          `:""}</a-switch>
        </template>
        ${A}`.replace(/ {8}/g,"")};H(()=>{s.value=u(k)});let g={text:!1,icon:!1};P(k,l=>{s.value=u(l),!g.text&&l.text&&l.icon&&(k.icon=!1),!g.icon&&l.icon&&l.text&&(k.text=!1),g.text=l.text,g.icon=l.icon},{deep:!0});const p=()=>{Object.assign(k,r)};return{...v(k),demotitle:I,democode:s,changeDemo:h,labelCol:{style:{width:"80px"}}}}}),dn={class:"code-box-demo-try"},kn={class:"code-box-meta markdown"},Cn={class:"code-box-title"},In={class:"code-box-description"};function rn(a,s,I,h,k,r){const u=c("check-outlined"),g=c("close-outlined"),p=c("a-switch"),l=c("a-radio"),C=c("a-radio-group"),A=c("a-form-item"),i=c("a-col"),Y=c("a-row"),N=c("a-form"),S=c("demo-try"),R=c("demo-box");return b(),G(R,{jsfiddle:{docHtml:"",demo:1,order:-1,title:{"zh-CN":"\u5728\u7EBF\u6F14\u793A","en-US":"Online Demo"},relativePath:"components/switch/demo/try.vue",sourceCode:"",jsSourceCode:"",isdemo:1}},{default:o(()=>[e(S,{jsfiddle:{demo:1,order:-1,title:{"zh-CN":"\u5728\u7EBF\u6F14\u793A","en-US":"Online Demo"},relativePath:"components/switch/demo/try.vue"},code:a.democode,onChangeDemo:a.changeDemo},{default:o(()=>[n("section",null,[n("section",dn,[e(p,{checked:a.checked,"onUpdate:checked":s[0]||(s[0]=d=>a.checked=d),disabled:a.disabled,size:a.size,loading:a.loading,"checked-children":a.text&&!a.icon?"\u5F00":null,"un-checked-children":a.text&&!a.icon?"\u5173":null},K({_:2},[a.icon?{name:"checkedChildren",fn:o(()=>[e(u)]),key:"0"}:void 0,a.icon?{name:"unCheckedChildren",fn:o(()=>[e(g)]),key:"1"}:void 0]),1032,["checked","disabled","size","loading","checked-children","un-checked-children"])]),n("section",kn,[n("section",Cn,f(a.demotitle),1),n("section",In,[e(N,{"label-col":a.labelCol},{default:o(()=>[e(A,{label:"size"},{default:o(()=>[e(C,{value:a.size,"onUpdate:value":s[1]||(s[1]=d=>a.size=d)},{default:o(()=>[(b(),V(X,null,J(["default","small"],d=>e(l,{key:d,value:d,name:"size"},{default:o(()=>[t(f(d),1)]),_:2},1032,["value"])),64))]),_:1},8,["value"])]),_:1}),e(Y,null,{default:o(()=>[e(i,{span:"8"},{default:o(()=>[e(A,{label:"checked"},{default:o(()=>[e(p,{checked:a.checked,"onUpdate:checked":s[2]||(s[2]=d=>a.checked=d),"checked-children":"\u5F00","un-checked-children":"\u5173"},null,8,["checked"])]),_:1})]),_:1}),e(i,{span:"8"},{default:o(()=>[e(A,{label:"disabled"},{default:o(()=>[e(p,{checked:a.disabled,"onUpdate:checked":s[3]||(s[3]=d=>a.disabled=d),"checked-children":"\u5F00","un-checked-children":"\u5173"},null,8,["checked"])]),_:1})]),_:1}),e(i,{span:"8"},{default:o(()=>[e(A,{label:"icon"},{default:o(()=>[e(p,{checked:a.icon,"onUpdate:checked":s[4]||(s[4]=d=>a.icon=d),"checked-children":"\u5F00","un-checked-children":"\u5173"},null,8,["checked"])]),_:1})]),_:1})]),_:1}),e(Y,null,{default:o(()=>[e(i,{span:"8"},{default:o(()=>[e(A,{label:"text"},{default:o(()=>[e(p,{checked:a.text,"onUpdate:checked":s[5]||(s[5]=d=>a.text=d),"checked-children":"\u5F00","un-checked-children":"\u5173"},null,8,["checked"])]),_:1})]),_:1}),e(i,{span:"8"},{default:o(()=>[e(A,{label:"loading"},{default:o(()=>[e(p,{checked:a.loading,"onUpdate:checked":s[6]||(s[6]=d=>a.loading=d),"checked-children":"\u5F00","un-checked-children":"\u5173"},null,8,["checked"])]),_:1})]),_:1})]),_:1})]),_:1},8,["label-col"])])])])]),_:1},8,["jsfiddle","code","onChangeDemo"])]),_:1},8,["jsfiddle"])}const An=m(gn,[["render",rn]]),hn=Z({setup(){const a=w({checked1:!0,checked2:!1});return{...v(a)}}}),bn=n("br",null,null,-1),mn=n("pre",{class:"language-vue"},[n("code",null,[n("span",{class:"token tag"},[n("span",{class:"token tag"},[n("span",{class:"token punctuation"},"<"),t("template")]),n("span",{class:"token punctuation"},">")]),t(`
  `),n("span",{class:"token tag"},[n("span",{class:"token tag"},[n("span",{class:"token punctuation"},"<"),t("div")]),n("span",{class:"token punctuation"},">")]),t(`
...
`),n("span",{class:"token punctuation"},"}"),n("span",{class:"token punctuation"},")"),n("span",{class:"token punctuation"},";"),t(`
`)])]),n("span",{class:"token tag"},[n("span",{class:"token tag"},[n("span",{class:"token punctuation"},"</"),t("script")]),n("span",{class:"token punctuation"},">")]),t(`
`)])],-1);function Gn(a,s,I,h,k,r){const u=c("a-switch"),g=c("demo-box");return b(),G(g,{jsfiddle:{us:"Mark a pending state of switch.",cn:"\u6807\u8BC6\u5F00\u5173\u64CD\u4F5C\u4ECD\u5728\u6267\u884C\u4E2D\u3002",docHtml:`<h2 id="zh-CN">zh-CN <a class="header-anchor" href="#zh-CN">
          <span aria-hidden="true" class="anchor">#</span>
        </a></h2>
<p>\u6807\u8BC6\u5F00\u5173\u64CD\u4F5C\u4ECD\u5728\u6267\u884C\u4E2D\u3002</p>
<h2 id="en-US">en-US <a class="header-anchor" href="#en-US">
