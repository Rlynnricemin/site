import{d as f,r as C,o as X,B as S,_ as A,k as h,l as b,w as e,f as o,b as n,t as H,a as P,h as V,e as t,F as j,j as c,K as y,s as Y}from"./index.07eaef2d.js";import{t as R}from"./trydemo.48000c6d.js";import{S as N}from"./SmileOutlined.3974a8a7.js";const F=f({mixins:[R],setup(a){const s=C(""),k=C(""),i=C({allowClear:!0,bordered:!0,size:"middle",disabled:!1,format:"HH:mm:ss"}),I={...i.value},g=(u,p,r="")=>i.value[u]!==p?r||" "+(i.value[u]===!1?":":"")+u.replace(/([A-Z])/g,function(v){return"-"+v.toLocaleLowerCase()})+(i.value[u]===!0?"":`="${i.value[u]}"`):"",l=u=>{let p="",r="";for(let v in u)p+=g(v,I[v]);return`<template>
          <a-time-picker${p} />
        </template>
